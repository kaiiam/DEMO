...
Make sure you have an ID range in the [idranges file](demo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [demo-edit.owl](demo-edit.owl)

** DO NOT EDIT demo.obo OR demo.owl in the top level directory **

[../../demo.owl](../../demo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/kaiiam/demo) for details.
 ...
 * [demo-idranges.owl](demo-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/demo_terms.txt file
...
Note: the demo_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as demo.owl and demo.obo and places
 ...
 * https://github.com/kaiiam/demo/releases
 * https://github.com/kaiiam/demo/releases/new
...
what is in the `owl:versionIRI` of the derived demo.owl (`data-version` in
demo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/demo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/demo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/kaiiam/demo.svg?branch=master)](https://travis-ci.org/kaiiam/demo)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/kaiiam](https://travis-ci.org/profile/kaiiam)
 2. click the "Sync account" button
 3. Click the tick symbol next to demo
